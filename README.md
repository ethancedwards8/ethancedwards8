...
I'm an A+, Security+, ISC2 CC, and GitLab Certified Git Associate.
...
- [Dracula Tmux](https://github.com/dracula/tmux) (800+ stars): I am the lead maintainer for this themed plugin that adds Kubernetes, Git, SSH, hardware, and other status support to your tmux status bar in an attractive way
- Linux Kernel Development: I am active in [Kernel Self Protection Project](https://kspp.github.io/) development.
- NixOS/Nixpkgs: I am an [active](https://repology.org/maintainer/ethan%40ethancedwards.com) (200+ packages) contributor to the Nixpkgs collection. I was a Summer of Nix 2025 intern where I worked on [NGIpkgs](https://github.com/ngi-nix/ngipkgs).

Some tools and skills I've picked up:

- Python, Typescript/Javascript, React, Bash/Shell
